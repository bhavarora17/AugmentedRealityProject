...
import app.com.augmentedrealitytraining.training.ar.ColorPicker.ColorPickerDialog;
import app.com.augmentedrealitytraining.training.ar.slideshow.BaseFragment;

import static app.com.augmentedrealitytraining.training.ar.ColorPicker.ColorPickerSwatch.OnColorSelectedListener;
...
public class EditActivity extends Fragment implements Toolbar.OnMenuItemClickListener {
    ...
    EditActivity(Intent intent, Notes notes, int requestCode){
    ...
    public void onStart() {
        ...
        //getWindow().setLayout((int) (width * 0.9), (int) (heigth * 0.6));
        ...
        bodyEdit = (EditText)getView().findViewById(R.id.bodyEdit);
        relativeLayoutEdit = (RelativeLayout)getView().findViewById(R.id.relativeLayoutEdit);
    ...
    protected void initDialogs(Context context) {
        ...
        colorPickerDialog = ColorPickerDialog.newInstance(R.string.dialog_note_colour,
                ...
                isTablet(getActivity()) ? ColorPickerDialog.SIZE_LARGE : ColorPickerDialog.SIZE_SMALL);
        ...
        saveChangesDialog = new AlertDialog.Builder(context)
                ...
                .setNegativeButton(R.string.no_button, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (bundle != null) {
                //            && bundle.getInt(NOTE_REQUEST_CODE) ==
                  //                  NEW_NOTE_REQUEST
                            ...
                            getFragmentManager().beginTransaction().replace(R.id.edit, new BaseFragment()).commit();
    ...
    protected void saveChanges() {
       ...
       //getView().setVisibility(View.GONE);
        getFragmentManager().beginTransaction().replace(R.id.edit, new BaseFragment()).commit();
        notes.onActivityResult(rCode, Activity.RESULT_OK, intent);
